...
class TransactionModel extends HiveObject {
  ...
  @HiveField(1)
  late String type; // SALE | PAYMENT | STOCK_ADD
  ...
  @HiveField(6)
  late String paymentMode; // CASH | UDHAAR | PAYMENT | STOCK_ADD

  @HiveField(7)
  late int totalAmountPaisa; // stored in paisa, display as rupees
...
class TransactionItem extends HiveObject {
  ...
  @HiveField(3)
  late int pricePaisa; // price per unit at time of sale
